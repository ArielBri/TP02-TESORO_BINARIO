...
void TesoroBinario::ejecutarTurno() {
    ...
    //this->bitmap->mostrarTablero(Tablero* tablero, Jugador* jugador) Metodo que puede estar dentro del TDA intefaz(en ese caso se le deberia spar por parametro el tablero y el jugadorActual)
    this->mostrarTablero();
    //OPCIONES DEL TURNO:
