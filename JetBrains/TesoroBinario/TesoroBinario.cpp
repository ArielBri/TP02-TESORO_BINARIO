...
void TesoroBinario::metodoEspiaChoque(Casillero *casillero, TipoFicha ficha) {
    this->eliminarFichaDeLaListaDeFichasDelJugador(casillero->getFicha());
    if(ficha==Tesoro||ficha==TesoroMina){
        casillero->setEstado(Inactivo);
    }
    if(ficha==TesoroMina){
        this->turnoValido = Invalido;
        ...
        if(casillero->getEstado()!=Inactivo) {
            ...
            if(casillero->getEstado()==Ocupado){
                switch (casillero->getFicha()->getTipo()) {
                    case Tesoro:
                        this->metodoEspiaChoque(casillero, Tesoro);
                        break;
                    case Espia:
                        this->metodoEspiaChoque(casillero, Espia);
                        break;
                    case TesoroMina:
                        this->metodoEspiaChoque(casillero, TesoroMina);
                        break;
                    case TesoroBlindado:
                        break;
                }
